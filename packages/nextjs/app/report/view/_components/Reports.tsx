...
import { metadata as metaData } from "~~/app/_metadata/metadata";
import { getReportsFromPinata } from "~~/app/lib/pinata";
                    ...
                    let preparedResponse = response?.rows?.map((res: any) => {
                        ...
                        if (keyvalues) {
                            ...
                            if (keyvalues.characteristics) {
                                ...
                                const characteristics = keyvalues.characteristics.split(",").map((val : string) => val.replaceAll('\"', ""));
